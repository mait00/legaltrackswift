...
import SouCaseScreen from '../screens/SouCase';
import KeywordScreen from '../screens/Keyword';
import CaseNotifyScreen from '../screens/CaseNotify';
import SouCaseNotifyScreen from '../screens/SouCaseNotify';
import ScannerScreen from '../screens/Scanner';
import CompanyScreen from '../screens/Company';
import CompanyInfoScreen from '../screens/CompanyInfo';
import OkvedsScreen from '../screens/Okveds';
...
const Tabs = () => {
  return (
      <Tab.Navigator screenOptions={({ route }) => ({
          ...
          tabBarLabelStyle: {
            marginBottom: Platform.OS === 'ios' ? (isIphoneX() ? -5 : 5) : 5,
            fontSize: 10,
            lineHeight: 12,
            fontWeight: '500',
